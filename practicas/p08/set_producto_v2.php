...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
	...
	<body>
        ...
        $nomRep = $link->prepare("SELECT * FROM productos1 WHERE nombre='{$nombre}'");
        $marRep = $link->prepare("SELECT * FROM productos1 WHERE marca='{$marca}'");
        $modRep = $link->prepare("SELECT * FROM productos1 WHERE modelo='{$modelo}'");
