        ...
        */
        ...
        if (finalJSON.marca.trim() === "" || finalJSON.marca.trim() === "NA") {
            ...
            if (!marcasValidas.includes(finalJSON.marca.trim())) {
                mensajesErrores.push("Marca no encontrada. Posibles marcas: a) Sombreros 2 hermanos, b) El rancho negro, c) Sombreros NL, d) El vaquero azul y e) Arthur Morgan importados.");
                hayErrores = true;
            }
        }
